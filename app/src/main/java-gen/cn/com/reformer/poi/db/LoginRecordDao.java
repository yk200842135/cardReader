...
/** 
 * DAO for table login_records.
*/
public class LoginRecordDao extends AbstractDao<LoginRecord, Long> {

    public static final String TABLENAME = "login_records";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'login_records' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'login_records'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, LoginRecord entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(LoginRecord entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
